...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://b50709dd-0e08-483b-a8e2-900f9d35004d.ws-us02.gitpod.io/#/workspace/next-dev-component)

Or clone locally:

```bash
$ git clone https://github.com/rimsila/next-dev-component
